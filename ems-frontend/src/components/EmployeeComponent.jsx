...
//         // these are the state variables that holds the validation errors
//         firstName:'',
//         lastName:'',
//         email:'',
//         department: ''
...
//         let valid=true;
//         const errorsCopy={... errors} //... this is called spread operator to copy object into another object and here we are going to copy the errors object
//         if(firstName.trim()) // if firstName is not null or not empty then no validation error
//         {
...
//                             <select 
//                                 className={`form-control ${errors.department ? 'is-invalid': ''}`} value={departmentId} onChange={(e)=>setDepartmentId(e.target.value)}>
